 ...
 * This file allows administrators to view and manage payments.
 */
...
// --- Fetch Payments Data ---
$payments = [];
$sql_payments = "SELECT p.payment_id, u.name AS user_name, u.email AS user_email,
                        p.amount, p.payment_method, p.payment_date, p.purpose
                 FROM payments p
...
if ($result_payments) {
    ...
    $message = "<div class='bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative mb-4' role='alert'>Error fetching payments: " . $conn->error . "</div>";
}
...
<body class="min-h-screen bg-gray-100 flex flex-col">
    <nav class="bg-indigo-700 p-4 shadow-md">
        <div class="container mx-auto flex justify-between items-center">
            <h1 class="text-white text-2xl font-bold">Admin Panel - Payments</h1>
    ...
    <main class="flex-grow container mx-auto p-6">
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden p-6">
                        ...
                        <tbody>
                            <?php foreach ($payments as $payment): ?>
                                <tr>
                                    ...
                                    <td>PKR <?php echo number_format(htmlspecialchars($payment['amount']), 2); ?></td>
            ...
            <?php else: ?>
                <p class="text-gray-700 text-center py-4">No payments found.</p>
            <?php endif; ?>
        </div>
    </main>
